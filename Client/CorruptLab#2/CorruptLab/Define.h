...
#define ROOT_PARAMETER_SKYBOX_TEX		    12
#define ROOT_PARAMETER_CLOUD_TEX		    13

#define ROOT_PARAMETER_TERRAIN_TEX		    14

#define ROOT_PARAMETER_LIGHT_MRT			0
#define ROOT_PARAMETER_CDN_MRT				3
