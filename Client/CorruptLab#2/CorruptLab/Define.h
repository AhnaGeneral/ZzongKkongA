...
#define OBJECT_TYPE_HOUSEALL            3 
#define OBJECT_TYPE_TREE                4
#define OBJECT_TYPE_TELEPHONEPOLE       5 
#define OBJECT_TYPE_DRUGMAKER           6
#define OBJECT_TYPE_ANIMALBONE          7
#define OBJECT_TYPE_BUILDINGMATERIAL    8
