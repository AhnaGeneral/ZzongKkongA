...
TriangleRect::TriangleRect(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, float fDepth, float fxPosition, float fyPosition, float fzPosition)
{
	m_nVertices = 6;
...
void TriangleRect::ReleaseUploadBuffers()
{
	CMesh::ReleaseUploadBuffers();
}

void TriangleRect::Render(ID3D12GraphicsCommandList* pd3dCommandList, int nSubSet)
{
	pd3dCommandList->IASetPrimitiveTopology(m_d3dPrimitiveTopology);
