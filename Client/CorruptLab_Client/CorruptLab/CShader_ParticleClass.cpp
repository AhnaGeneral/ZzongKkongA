...
D3D12_INPUT_LAYOUT_DESC Shader_ParticleClass::CreateInputLayout()
{
	...
	pd3dInputElementDescs[1] = { "SIZE", 0, DXGI_FORMAT_R32_FLOAT, 0, 12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
	pd3dInputElementDescs[2] = { "COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 16, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 };
...
D3D12_RASTERIZER_DESC Shader_ParticleClass::CreateRasterizerState()
{
...
{
	return(CShader::CompileShaderFromFile(L"HLSL_ParticleSystem.hlsl", "particleVertexShader", "vs_5_1", ppd3dShaderBlob));
}
...
D3D12_SHADER_BYTECODE Shader_ParticleClass::CreateGeometryShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"HLSL_ParticleSystem.hlsl", "ParticleGeometryShader", "gs_5_1", ppd3dShaderBlob));
}
...
D3D12_BLEND_DESC Shader_ParticleClass::CreateBlendState()
{
	...
	d3dBlendDesc.RenderTarget[0].SrcBlend = D3D12_BLEND_SRC_ALPHA;//ΩÍ¿Ã¥ı
	d3dBlendDesc.RenderTarget[0].DestBlend = D3D12_BLEND_INV_SRC_ALPHA; //∑£¥ı≈∏∞Ÿ
