...
void CGameScene::ReleaseObjects()
{
	...
	if (m_pCObjectWater) m_pCObjectWater->ReleaseUploadBuffers();
	if (m_pCObjectWater) m_pCObjectWater->Release();
	if (m_pSoftParticleShader) m_pSoftParticleShader->ReleaseUploadBuffers();
